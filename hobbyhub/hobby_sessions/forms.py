...
class CreateSessionForm(forms.Form):
     ...
     def clean_date(self):
          ...
          if form_date and form_date > dt.today():
               raise forms.ValidationError("Hmm... that date hasn’t happened yet. Please pick a date that’s in the past or today.")
          return form_date
     ...
     def clean(self):
          ...
          if session_start > now:
               self.add_error(
                    "start_time",
                    "Hmm... that time hasn’t happened yet. Please pick a date that’s in the past or right now."
               )
